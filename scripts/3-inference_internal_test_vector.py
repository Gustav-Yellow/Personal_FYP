...
"""
        ...
        print(f"答案:{result_item['answer']}, 预测:{result_item['pred_answer']}")
...
if __name__ == "__main__":
    ...
    process_dataset(
        ...
        output_filename="internal_test_CRMUS_CR_pred_vector.json",
    ...
    process_dataset(
        ...
        output_filename="internal_test_CRMUS_MU_pred_vector.json",
        chat_model=chat_model,
